...
def convert_images(inputs, load_function, transformation_function=None, normalize_function=None):
    image, label = inputs
...
def main(args):
    ...
    encode_function = functools.partial(convert_images, load_function=load_function,
                                        transformation_function=transformation_function, normalize_function=normalize_function)
    if args.mode == "normal":
